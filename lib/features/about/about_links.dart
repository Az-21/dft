...
const List<List<String>> constDataInfo = [
  ["Made by Az-21", "Built with Flutter", "${_github}Az-21"],
  ["Source Code", "View on GitHub | GPL v3", "${_github}Az-21/dft"],
  ["Report Issue", "Open a GitHub Issue", "${_github}Az-21/dft/issues"],
];

const List<List<String>> constDataCredit = [
  ["Complex", "Apache 2.0 License", "${_github}rwl/complex"],
  [
    "Dynamic Color",
    "Apache 2.0 License",
